    ...
    <div className='container sp mt-10 space-y-5 lg:space-y-10 '>
      {product && (
        <div>
          ...
          <div className='flex flex-col xl:flex-row gap-6 items-center  shadow-md'>
            <div className=' flex flex-col md:flex-row'>
              ...
              <div className='md:w-1/2 p-4'>
                ...
                <div className='flex justify-between items-center border-b pb-3'>
                  <div className='text-xl flex flex-col gap-1 text-gray-500'>
                    <del>
                      {" "}
            ...
            <div className='flex flex-col  lg:w-80 w-full gap-6 items-center justify-center'>
